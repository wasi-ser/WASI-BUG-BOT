...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By Musa Rajput Sir Bot Owner ${ownername} For more  Hacks Search On telegram Musa_x0`).catch(_ => _)
        }
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}\n Premium is free! \n Put Your number in Premium json in file! \n do not know check video on Telegram channel Musa Rajput`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'runtime':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `Yt Musa Rajput`,
                            body: `Love from Musa Rajput ❤️`,
                            thumbnailUrl: 'https://i.ibb.co/5hYWrRH/thumb.png',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF Musa is on telegram Musa_x0❤️`,
                            body: `Love You bro 😘`,
                            thumbnailUrl: 'https://i.ibb.co/5hYWrRH/thumb.png',
                            sourceUrl: global.link,
                            mediaType: 1,
